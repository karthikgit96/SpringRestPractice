...
public class RouteController {
	...
	public ResponseEntity<String> updateRoute(@PathVariable("routeId") Integer routeId,@Valid @RequestBody RouteDTO routeDTO) throws NoSuchRouteException{
		String message = env.getProperty(routeService.updateRoute(routeId,routeDTO));
